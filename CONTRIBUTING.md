...
- 用途：本文档说明如何向 `HkEquityStrategies` 提交低风险、可审阅的变更。
...
Thanks for contributing to `HkEquityStrategies`.
...
- Preserve this repository's boundary as a Hong Kong equity strategy package; do not move broker execution, live-allocation decisions, private credentials, or unrelated platform logic into it.
