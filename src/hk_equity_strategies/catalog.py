...
STRATEGY_DEFINITIONS: dict[str, StrategyDefinition] = {
    ...
    HK_ETF_REGIME_ROTATION_PROFILE: _build_strategy_definition(
        HK_ETF_REGIME_ROTATION_PROFILE,
        component_name="signal_logic",
...
STRATEGY_METADATA: dict[str, StrategyMetadata] = {
    ...
    HK_ETF_REGIME_ROTATION_PROFILE: StrategyMetadata(
        canonical_profile=HK_ETF_REGIME_ROTATION_PROFILE,
        display_name="HK ETF Regime Rotation",
        description=(
            "Research candidate for low-turnover HK-listed ETF regime rotation using daily market history."
        ),
