...
def build_execution_capacity_policy(profile: str) -> dict[str, Any]:
    return {
        ...
        "description": "Runtime dry-run evidence must prove HK ETF liquidity, board-lot routing, odd-lot avoidance, VCM/price-band controls, and conservative ADV capacity before live enablement.",
    }
