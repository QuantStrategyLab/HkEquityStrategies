...
FIRST_SNAPSHOT_CANDIDATES = (HK_LOW_VOL_DIVIDEND_QUALITY_SNAPSHOT_PROFILE,)
...
SNAPSHOT_REQUIRED_REPOSITORY_POLICIES: tuple[str, ...] = ("quality_yield_live_enablement_policy",)
...
CURATED_LIVE_ENABLEMENT_STRATEGY_RANKING: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "annualized_return": 0.1334,
        "max_drawdown": -0.2305,
        "why": (
            "Only retained HK snapshot-backed profile after proxy-cycle triage; passed long, medium, and short "
            "30% drawdown gates while keeping the strategy style defensive and explainable."
        ),
        "next_action": (
...
DEPRIORITIZED_LIVE_ENABLEMENT_PROFILES: tuple[dict[str, str], ...] = (
    {
        ...
        "reason": "Removed from the package after the 2026-06-03 rerun: full-sample annualized return was 0.72% and max drawdown was -47.58%.",
    },
    {
...
SNAPSHOT_SCAFFOLD_NOTES: dict[str, tuple[str, ...]] = {
    HK_LOW_VOL_DIVIDEND_QUALITY_SNAPSHOT_PROFILE: (
        "Only retained snapshot-backed HK runtime profile after the 2026-06-03 proxy-cycle ranking.",
        "The proxy cycle ranked it first with 13.34% long annualized return and -23.05% long max drawdown; long, medium, and short windows all passed the 30% drawdown gate.",
