...
from hk_equity_strategies.catalog import HK_BLUE_CHIP_LEADER_ROTATION_PROFILE
from hk_equity_strategies.runtime_adapters import (
    describe_platform_runtime_requirements,
    get_platform_runtime_adapter,
)
from hk_equity_strategies.strategies.blue_chip_leader_rotation import REQUIRED_FEATURE_COLUMNS, SNAPSHOT_CONTRACT_VERSION
...
def test_runtime_requirements_match_snapshot_contract():
    requirements = describe_platform_runtime_requirements(HK_BLUE_CHIP_LEADER_ROTATION_PROFILE, platform_id="longbridge")
